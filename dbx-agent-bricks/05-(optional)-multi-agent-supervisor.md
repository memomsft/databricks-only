...
3. Add a **Description**: Add some guidelines for Genie. Example: A retail assistant that can answer policy questions from documents and query customer and order data
